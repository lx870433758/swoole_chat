...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script type="text/javascript" src="{{asset('auth/js/jquery-1.9.0.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('auth/images/login.js')}}"></script>
...
<div class="login" style="margin-top:50px;">
        ...
        <div class="web_login" id="web_login">
            ...
            <div class="login-box">
                ...
                <div class="login_form">
                    <form action="/auth/post_login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post"><input type="hidden" name="did" value="0"/>
                        <div id="loginCue" class="cue">请输入用户名密码</div>
                        ...
                        @endif
                        <div style="padding-left:50px;margin-top:20px;"><input type="button" id="loginsub" value="登 录" style="width:150px;" class="button_blue"/></div>
                    </form>
                </div>
    ...
    <div class="qlogin" id="qlogin" style="display: none; ">
        ...
        <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="/auth/post_register" method="post">
